...
import PropertySkeleton from "../../Skeletons/PropertyFormSkeleton"
import {
  areaMeasures,
  bathroomOpts,
  bedroomOpts,
...
{ loading && <PropertySkeleton/>}
      { !loading && <div className="flex flex-col gap-5 max-w-sm">
        ...
        <button onClick={handleSubmit} className={styles.BlackButton}>
