  ...
  return (
    <div className="px-8  flex flex-col gap-5 w-full max-w-[809px] bg-white">
      <div className="flex justify-between items-center">
        <div>
          <div className="text-2xl font-medium mb-2 capitalize">{listing.area.size +" " + listing.area.type +" " + listing.subPropertyType + " for " + listing.purpose + " in " + listing.location + ", " + listing.city}</div>
