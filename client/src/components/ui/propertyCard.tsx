...
const PropertyCard: FC<Props> = ({
  ...
  return (
    <>
      <div className={`${width ? "w-72" : "w-[260px]"} font-Poppins bg-white rounded-md overflow-hidden shadow-lg`}>
        <div
          className="pic h-40  relative overflow-hidden group"
          ref={sliderRef}
        >
          ...
          <div className="z-[2] rounded font-medium text-[.6rem] p-1 text-white absolute right-2 bottom-2 bg-black/40 capitalize flex gap-1 items-center"><FaEye />{`${views}`}</div>
        ...
        <div className="p-2 rounded-b flex-col flex gap-2">
